...
| [`web/`](web) | The Renqun web app (Next.js): a front page built on live chain data, markets with a live oracle chart and the bet ticket, "Just ask" yes/no questions for later today, portfolio with cash-out and claims, the Earn pool, Add MUSD. Connects any browser wallet that announces itself (MetaMask, Rabby, OKX…) and adds Mezo to it |
